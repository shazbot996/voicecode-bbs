...
Analyze the codebase and the scope described below, then produce a well-structured \
feature spec in Markdown. The spec should clearly define the problem, proposed \
solution, technical design, scope boundaries, and success criteria — giving any \
developer or AI agent enough context to implement the feature without ambiguity.
...
- **Non-Goals**: What is explicitly out of scope — things that might seem related \
...
the spec should acknowledge and build on that.
- **Focus on "what" and "why", not "how to implement step by step".** That is \
what a PLAN document is for. The spec defines the destination, not the route.
