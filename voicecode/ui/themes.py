...
FALLBACK_MAP: dict[int, int] = {
    ...
    208: curses.COLOR_YELLOW,   # giedi orange -> yellow
    166: curses.COLOR_RED,      # giedi dark orange -> red
    235: curses.COLOR_BLACK,    # giedi charcoal bg -> black
    54: curses.COLOR_MAGENTA,   # oblivion deep purple -> magenta
    91: curses.COLOR_MAGENTA,   # oblivion purple -> magenta
    57: curses.COLOR_BLUE,      # oblivion violet -> blue
    30: curses.COLOR_CYAN,      # renegade dark cyan -> cyan
}
...
THEMES: dict[str, ThemeDict] = {
    ...
    "giedi": {
        "header":            {"fg": 208,                   "bg": 235,                  "attrs": curses.A_BOLD},
        "prompt":            {"fg": 208,                   "bg": -1,                   "attrs": 0},
        "dictation":         {"fg": 166,                   "bg": -1,                   "attrs": 0},
        "status":            {"fg": 208,                   "bg": 235,                  "attrs": 0},
        "help_bar":          {"fg": curses.COLOR_BLACK,    "bg": 208,                  "attrs": 0},
        "recording":         {"fg": curses.COLOR_WHITE,    "bg": curses.COLOR_RED,     "attrs": curses.A_BOLD},
        "banner":            {"fg": 208,                   "bg": -1,                   "attrs": curses.A_BOLD},
        "accent":            {"fg": curses.COLOR_RED,      "bg": -1,                   "attrs": 0},
        "agent":             {"fg": 166,                   "bg": -1,                   "attrs": 0},
        "xfer":              {"fg": 208,                   "bg": -1,                   "attrs": curses.A_BOLD},
        "voice":             {"fg": 208,                   "bg": -1,                   "attrs": 0},
        "ctx_green":         {"fg": 208,                   "bg": -1,                   "attrs": 0},
        "ctx_yellow":        {"fg": curses.COLOR_YELLOW,   "bg": -1,                   "attrs": 0},
        "ctx_red":           {"fg": curses.COLOR_RED,      "bg": -1,                   "attrs": 0},
        "selection":         {"fg": curses.COLOR_BLACK,    "bg": 208,                  "attrs": curses.A_BOLD},
        "tts":               {"fg": 208,                   "bg": -1,                   "attrs": 0},
        "tts_unavailable":   {"fg": 166,                   "bg": -1,                   "attrs": 0},
        "sect_red":          {"fg": curses.COLOR_RED,      "bg": 235,                  "attrs": 0},
        "submenu":           {"fg": 208,                   "bg": 235,                  "attrs": 0},
        "settings_title":    {"fg": curses.COLOR_BLACK,    "bg": 208,                  "attrs": curses.A_BOLD},
        "fav_empty":         {"fg": 235,                   "bg": -1,                   "attrs": 0},
        "fav_filled":        {"fg": curses.COLOR_RED,      "bg": -1,                   "attrs": curses.A_BOLD},
        "publish":           {"fg": 166,                   "bg": -1,                   "attrs": 0},
        "publish_title":     {"fg": curses.COLOR_BLACK,    "bg": 208,                  "attrs": curses.A_BOLD},
        "publish_hint":      {"fg": 208,                   "bg": 235,                  "attrs": 0},
        "doc_body":          {"fg": 208,                   "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_heading":       {"fg": curses.COLOR_RED,      "bg": curses.COLOR_BLACK,   "attrs": curses.A_BOLD},
        "doc_dim":           {"fg": 166,                   "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_list_bg":       {"fg": 208,                   "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_list_border":   {"fg": 166,                   "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_badge_cyan":    {"fg": 208,                   "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_badge_green":   {"fg": 208,                   "bg": curses.COLOR_BLACK,   "attrs": curses.A_BOLD},
        "doc_badge_magenta": {"fg": curses.COLOR_RED,      "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_badge_yellow":  {"fg": 208,                   "bg": curses.COLOR_BLACK,   "attrs": 0},
    },
    "renegade": {
        "header":            {"fg": curses.COLOR_WHITE,    "bg": 30,                   "attrs": curses.A_BOLD},
        "prompt":            {"fg": curses.COLOR_CYAN,     "bg": -1,                   "attrs": 0},
        "dictation":         {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "status":            {"fg": curses.COLOR_WHITE,    "bg": 30,                   "attrs": 0},
        "help_bar":          {"fg": curses.COLOR_MAGENTA,  "bg": 30,                   "attrs": 0},
        "recording":         {"fg": curses.COLOR_WHITE,    "bg": curses.COLOR_RED,     "attrs": curses.A_BOLD},
        "banner":            {"fg": curses.COLOR_CYAN,     "bg": -1,                   "attrs": curses.A_BOLD},
        "accent":            {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": curses.A_BOLD},
        "agent":             {"fg": curses.COLOR_CYAN,     "bg": -1,                   "attrs": 0},
        "xfer":              {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": curses.A_BOLD},
        "voice":             {"fg": curses.COLOR_CYAN,     "bg": -1,                   "attrs": curses.A_BOLD},
        "ctx_green":         {"fg": curses.COLOR_CYAN,     "bg": -1,                   "attrs": 0},
        "ctx_yellow":        {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "ctx_red":           {"fg": curses.COLOR_RED,      "bg": -1,                   "attrs": 0},
        "selection":         {"fg": curses.COLOR_WHITE,    "bg": curses.COLOR_MAGENTA, "attrs": curses.A_BOLD},
        "tts":               {"fg": curses.COLOR_CYAN,     "bg": -1,                   "attrs": 0},
        "tts_unavailable":   {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "sect_red":          {"fg": curses.COLOR_RED,      "bg": 30,                   "attrs": 0},
        "submenu":           {"fg": curses.COLOR_MAGENTA,  "bg": 30,                   "attrs": 0},
        "settings_title":    {"fg": curses.COLOR_WHITE,    "bg": curses.COLOR_MAGENTA, "attrs": curses.A_BOLD},
        "fav_empty":         {"fg": 30,                    "bg": -1,                   "attrs": 0},
        "fav_filled":        {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": curses.A_BOLD},
        "publish":           {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "publish_title":     {"fg": curses.COLOR_WHITE,    "bg": curses.COLOR_MAGENTA, "attrs": curses.A_BOLD},
        "publish_hint":      {"fg": curses.COLOR_CYAN,     "bg": 30,                   "attrs": 0},
        "doc_body":          {"fg": curses.COLOR_CYAN,     "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_heading":       {"fg": curses.COLOR_MAGENTA,  "bg": curses.COLOR_BLACK,   "attrs": curses.A_BOLD},
        "doc_dim":           {"fg": 30,                    "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_list_bg":       {"fg": curses.COLOR_CYAN,     "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_list_border":   {"fg": curses.COLOR_MAGENTA,  "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_badge_cyan":    {"fg": curses.COLOR_CYAN,     "bg": curses.COLOR_BLACK,   "attrs": curses.A_BOLD},
        "doc_badge_green":   {"fg": curses.COLOR_CYAN,     "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_badge_magenta": {"fg": curses.COLOR_MAGENTA,  "bg": curses.COLOR_BLACK,   "attrs": curses.A_BOLD},
        "doc_badge_yellow":  {"fg": curses.COLOR_MAGENTA,  "bg": curses.COLOR_BLACK,   "attrs": 0},
    },
    "oblivion": {
        "header":            {"fg": curses.COLOR_WHITE,    "bg": 54,                   "attrs": curses.A_BOLD},
        "prompt":            {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "dictation":         {"fg": 57,                    "bg": -1,                   "attrs": 0},
        "status":            {"fg": curses.COLOR_WHITE,    "bg": 54,                   "attrs": 0},
        "help_bar":          {"fg": curses.COLOR_MAGENTA,  "bg": 54,                   "attrs": 0},
        "recording":         {"fg": curses.COLOR_WHITE,    "bg": curses.COLOR_RED,     "attrs": curses.A_BOLD},
        "banner":            {"fg": 91,                    "bg": -1,                   "attrs": curses.A_BOLD},
        "accent":            {"fg": 57,                    "bg": -1,                   "attrs": 0},
        "agent":             {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "xfer":              {"fg": 91,                    "bg": -1,                   "attrs": curses.A_BOLD},
        "voice":             {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "ctx_green":         {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "ctx_yellow":        {"fg": 91,                    "bg": -1,                   "attrs": 0},
        "ctx_red":           {"fg": curses.COLOR_RED,      "bg": -1,                   "attrs": 0},
        "selection":         {"fg": curses.COLOR_WHITE,    "bg": 91,                   "attrs": curses.A_BOLD},
        "tts":               {"fg": curses.COLOR_MAGENTA,  "bg": -1,                   "attrs": 0},
        "tts_unavailable":   {"fg": 54,                    "bg": -1,                   "attrs": 0},
        "sect_red":          {"fg": curses.COLOR_RED,      "bg": 54,                   "attrs": 0},
        "submenu":           {"fg": curses.COLOR_WHITE,    "bg": 54,                   "attrs": 0},
        "settings_title":    {"fg": curses.COLOR_WHITE,    "bg": 91,                   "attrs": curses.A_BOLD},
        "fav_empty":         {"fg": 54,                    "bg": -1,                   "attrs": 0},
        "fav_filled":        {"fg": 91,                    "bg": -1,                   "attrs": curses.A_BOLD},
        "publish":           {"fg": 91,                    "bg": -1,                   "attrs": 0},
        "publish_title":     {"fg": curses.COLOR_WHITE,    "bg": 91,                   "attrs": curses.A_BOLD},
        "publish_hint":      {"fg": curses.COLOR_MAGENTA,  "bg": 54,                   "attrs": 0},
        "doc_body":          {"fg": curses.COLOR_MAGENTA,  "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_heading":       {"fg": curses.COLOR_WHITE,    "bg": curses.COLOR_BLACK,   "attrs": curses.A_BOLD},
        "doc_dim":           {"fg": 54,                    "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_list_bg":       {"fg": curses.COLOR_MAGENTA,  "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_list_border":   {"fg": 91,                    "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_badge_cyan":    {"fg": 57,                    "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_badge_green":   {"fg": curses.COLOR_MAGENTA,  "bg": curses.COLOR_BLACK,   "attrs": 0},
        "doc_badge_magenta": {"fg": 91,                    "bg": curses.COLOR_BLACK,   "attrs": curses.A_BOLD},
        "doc_badge_yellow":  {"fg": curses.COLOR_MAGENTA,  "bg": curses.COLOR_BLACK,   "attrs": 0},
    },
}
